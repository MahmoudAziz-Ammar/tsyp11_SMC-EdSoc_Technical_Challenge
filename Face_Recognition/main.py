...
csv_file = open('student_data.csv', 'w', newline='')
csv_writer = csv.writer(csv_file)
csv_writer.writerow(['ID', 'name', 'total_attendance','major','gender','academic_performance','last_attendance_time'])
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                print(studentInfo)
                csv_writer.writerow([studentInfo['ID'], studentInfo['name'], studentInfo['total_attendance'],studentInfo['major'],studentInfo['gender'],studentInfo['academic_performance'],studentInfo['last_attendance_time']])                #get image from storage
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['academic_performance']), (1025, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
